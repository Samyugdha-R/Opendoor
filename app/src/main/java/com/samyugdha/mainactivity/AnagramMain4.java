...
public class AnagramMain4 extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_anagram4);
    ...
    private void validate() {
        ...
        if (wordToFind.equals(w)) {
            ...
            Intent anagram=new Intent(AnagramMain4.this,Class4q3.class);
    ...
    public void newGame()
    {
        wordToFind = Anagram4.randomWord();
        String wordShuffled = Anagram4.shuffleWord(wordToFind);
