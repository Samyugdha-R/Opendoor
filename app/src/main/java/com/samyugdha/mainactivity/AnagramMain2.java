...
public class AnagramMain2 extends AppCompatActivity implements View.OnClickListener{
    ...
    private void validate() {
        ...
        if (wordToFind.equals(w)) {
            ...
            Intent anagram=new Intent(AnagramMain2.this,Class2q3.class);
    ...
    public void newGame()
    {
        wordToFind = Anagram2.randomWord();
        String wordShuffled = Anagram2.shuffleWord(wordToFind);
